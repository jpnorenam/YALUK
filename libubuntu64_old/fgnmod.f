     ...
     1                    iniflg, ierflg)
      ...
      DATA refnam(3) / 'STHYST' /
      DATA refnam(4) / 'DYHYST' /
      DATA refnam(5) / ' ' /
      DATA refnam(6) / ' ' /
      DATA refnam(7) / ' ' /
      DATA refnam(8) / ' ' /
     ...
     1           .AND. name(ichar).EQ.refnam(iname)(ichar:ichar))
      ...
      ELSE IF ( iname.EQ.3 ) THEN
       IF (iniflg.EQ.1) THEN
        !CALL sthysti(xdata, xin, xout, xvar)
       ELSE
        !CALL sthystm(xdata, xin, xout, xvar)
       ENDIF
      CONTINUE !      -------------------------------------------
      ELSE IF ( iname.EQ.4 ) THEN
       IF (iniflg.EQ.1) THEN
        !CALL dyhysti(xdata, xin, xout, xvar)
       ELSE
        !CALL dyhystm(xdata, xin, xout, xvar)
       ENDIF
      CONTINUE !      -------------------------------------------
      ...
      DATA refnam(2) / 'SAMPLE_C_FUNCTION' /
      DATA refnam(3) / 'C_SEED' /
      DATA refnam(4) / 'C_RANDOM' /
      DATA refnam(5) / ' ' /
      DATA refnam(6) / ' ' /
      DATA refnam(7) / ' ' /
      DATA refnam(8) / ' ' /
